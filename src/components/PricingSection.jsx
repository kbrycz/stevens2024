      ...
      {amounts.map((amount, index) => {
        ...
        return (
          <button
            ...
            onMouseLeave={(e) => { if (!isSelected) e.target.style.backgroundColor = '#ffffff' }}
          >
...
const SectionHeading = memo(function SectionHeading() {
  return (
    <TextAnimate as="h2" animation="fadeIn" by="word" delay={0.2} once className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold mb-10 leading-tight tracking-tight text-center" style={{ color: colors.primary[500] }}>
...
const InfoText = memo(function InfoText() {
  return (
    <div className="text-center space-y-2">
      ...
      <TextAnimate as="p" animation="fadeIn" by="word" delay={0.1} once className="text-xs md:text-sm text-neutral-500">
...
function PricingSection() {
  return (
    <section className="w-full py-16 md:py-24 px-6 md:px-12 lg:px-16" style={{ backgroundColor: colors.accent[200] }}>
